...
class ExtractionWorker(QThread):
    ...
    def run(self):
        try:
            # BƯỚC 1: Kiểm tra input trước khi tạo bất kỳ thư mục nào
            ...
            # Kiểm tra nếu là folder
                ...
                # Đếm số file trong folder (recursive)
            ...
            # BƯỚC 2: Input hợp lệ, bắt đầu tạo cấu trúc thư mục
            self.progress.emit(15, "Creating directory structure...")

            root_dir = input_path.parent / self.case_id
            ...
            # Copy input vào RAW
            self.progress.emit(20, "Copying input to RAW directory...")
            raw_dir.mkdir(parents=True, exist_ok=True)

            if self.mode == "file":
                shutil.copy2(self.input_path, raw_dir / input_path.name)
            else:
            ...
            with open(log_file, 'w', encoding='utf-8') as log:
                ...
                if total_files == 0:
                    ...
                    self.finished.emit(False, "No files found in RAW directory after copy")
                    return
